...
async function showInviteBannerIfPending() {
  ...
  try {
    ...
    host.style.display = 'block';
    // He was invited on WhatsApp, on the phone he is holding — so the code
    // should arrive there, not by email. Preselect that tab.
    const waTab = document.getElementById('login-tab-wa');
