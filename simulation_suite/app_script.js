...
const APP_VERSION = 'v0.18.0 · live';
...
function renderLibrary() {
  ...
  const shareBtn = (!AppState.isDemoMode && allRecs.length > 0)
    ? '<button class="btn btn-secondary" data-action="open-share-list" style="flex-shrink:0;white-space:nowrap;">🔗 Share as list</button>'
    : '';
